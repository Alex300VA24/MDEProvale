...
@section('title', 'Crear Beneficiario - PROVALE')

@section('content')
<div class="bg-white rounded-2xl border-2 border-wheat shadow-sm overflow-hidden">
    <div class="flex items-center justify-between px-6 py-5 border-b-2 border-wheat">
        <h3 class="font-extrabold text-charcoal text-xl flex items-center gap-3">
            <i class="fas fa-plus-circle text-leaf"></i> Nuevo Beneficiario
        </h3>
    ...
    <form action="{{ route('socios-beneficiarios.beneficiarios.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="flex gap-3 mt-6">
            ...
            <a href="{{ route('socios-beneficiarios.beneficiarios.index') }}" class="btn-secondary">Cancelar</a>
        </div>
    </form>
</div>
@endsection
