...
@section('content')
{{-- All data is now provided by DashboardController —
     totalPartners, activePartners, totalBeneficiaries, totalAssociations,
     totalProducts, totalStock, partnersByClub, pecosaData, ingresosData,
