...
<div class="bg-white rounded-2xl border-2 border-wheat shadow-sm overflow-hidden">
    <div class="flex items-center justify-between px-6 py-5 border-b-2 border-wheat flex-wrap gap-4">
        ...
        <div class="flex gap-3">
            <a href="{{ route('productos-pecosas.productos.reportes') }}" class="btn-secondary flex items-center gap-2">
    ...
    <form method="GET" action="{{ route('productos-pecosas.productos.index') }}" class="flex gap-4 px-6 py-4 flex-wrap border-b border-wheat bg-cream">
                ...
                <tr>
                    ...
                    <td class="px-6">
                        <div class="flex gap-2">
                            <a href="{{ route('productos-pecosas.productos.show', $product) }}" class="btn-action bg-sky-light text-[#0284C7] hover:bg-sky hover:text-white">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('productos-pecosas.productos.edit', $product) }}" class="btn-action bg-sun-light text-[#D97706] hover:bg-sun hover:text-white">
