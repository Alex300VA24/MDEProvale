...
<div class="bg-white rounded-2xl border-2 border-wheat shadow-sm overflow-hidden">
    ...
    <form method="GET" action="{{ route('club-reconocimientos.club.index') }}" class="flex gap-4 px-6 py-4 flex-wrap border-b border-wheat bg-cream">
        ...
        <div class="flex items-end gap-2">
            ...
            <a href="{{ route('club-reconocimientos.club.index') }}" class="btn-secondary">
                ...
                <tr>
                    ...
                    <td class="px-6">
                        <div class="flex gap-2">
                            <a href="{{ route('club-reconocimientos.club.show', $association) }}" class="btn-action bg-sky-light text-[#0284C7] hover:bg-sky hover:text-white">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('club-reconocimientos.club.edit', $association) }}" class="btn-action bg-sun-light text-[#D97706] hover:bg-sun hover:text-white">
