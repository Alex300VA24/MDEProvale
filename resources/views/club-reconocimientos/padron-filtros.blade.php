...
@section('title', 'Padrón de Comités - PROVALE')
...
<div class="bg-white rounded-2xl border-2 border-wheat shadow-sm overflow-hidden mb-6">
    ...
    <div class="p-6">
        <p class="text-earth mb-6">Seleccione el mes y año para generar el padrón histórico de comités:</p>

        <form action="{{ route('club-reconocimientos.club.padron') }}" method="GET" target="_blank" class="space-y-6" data-no-loading>
            ...
            <div class="flex justify-center">
                <button type="submit" class="btn-primary px-8 py-3 text-lg flex items-center gap-3">
                    <i class="fas fa-file-pdf"></i> Generar Padrón de Comités
                </button>
            </div>
        </form>
    </div>
